#!/usr/bin/env python3
"""Validate source assets and the built SCORM package for JEMIX lesson 2.1."""
...
PACKAGE = ROOT / "dist" / "module-02" / "JEMIX_Lesson_2_1_SCORM.zip"
LOGO = ROOT / "academy-assets" / "logo" / "jemix-logo.png"
PUMP = ROOT / "academy-assets" / "pumps" / "jemix-pump.png"
AUDIO_DIR = ROOT / "voice" / "modules" / "module-02" / "lesson-2.1" / "audio"
...
REQUIRED_PACKAGE_FILES = {
    ...
    "img/jemix-logo.png",
    "img/jemix-pump.png",
    *(f"audio/slide{i:02d}.mp3" for i in range(1, 13)),
}
...
def main() -> None:
    validate_sources()
    validate_package()
    print(f"OK: {PACKAGE.relative_to(ROOT)} contains all required lesson 2.1 assets")
